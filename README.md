...
[下载 Codex额度小窗-1.0.0-portable-10s.exe](dist/Codex额度小窗-1.0.0-portable-10s.exe)
...
这个版本把小窗置顶检测从 2 秒调整为 10 秒，以降低空闲时的检查频率。额度自动获取仍默认每 10 分钟执行一次。
